...
- :construction: [PrivateLens](https://github.com/midsu/PrivateLens)
- :construction: [CandleVision](https://github.com/midsu/CandleVision-)
- :construction: [PokerHandRank](https://github.com/midsu/PokerHandRank)
- :checkered_flag: [MPI-Parallelized-NLP](https://github.com/midsu/MPI-Parallelized-NLP)
- :checkered_flag: [Vaccination rate](https://github.com/midsu/vaccinationRate)
- :checkered_flag: [Bernstein-s-conditions-for-Data-Dependencies](https://github.com/midsu/Bernstein-s-conditions-for-Data-Dependencies)
- :checkered_flag: [Dynamic vs. Exhaustive algorithm optimization](https://github.com/midsu/Algorithm_CPSC_335)
- :checkered_flag: [Clustering a Sensor network using NIC addresses](https://github.com/midsu/Algorithm_CPSC_335/tree/main/Project-3)
- :checkered_flag: [Container ship and seaport good transportation problem, "Drayage"](https://github.com/midsu/Algorithm_CPSC_335/blob/main/Project-2/Project%202%20Requirements%20335.01%20(1).pdf)
- :checkered_flag: [Pairs trading - summer research intern](https://github.com/midsu/Pairs_Trading)
